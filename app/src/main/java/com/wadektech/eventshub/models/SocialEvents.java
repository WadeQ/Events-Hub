...
public class SocialEvents {
    ...
    @Ignore
    public SocialEvents(int id, String title, String shortDesc, long date, String location, int entryFees) {
        this.id = id;
        this.title = title;
    ...
    public SocialEvents(String title, String shortDesc, long date, String location, int entryFees) {
        this.title = title;
        this.shortDesc = shortDesc;
        this.date = date;
        this.location = location;
