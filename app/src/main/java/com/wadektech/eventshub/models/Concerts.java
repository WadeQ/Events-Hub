...
public class Concerts {
    ...
    public Concerts(String title, String shortDesc, long date, String location, int entryFees) {
        this.title = title;
    ...
    @Ignore
    public Concerts(int id, String title, String shortDesc, long date, String location, int entryFees) {
        this.id = id;
        this.title = title;
        this.shortDesc = shortDesc;
        this.date = date;
