...
public class SignUpActivity extends AppCompatActivity {
    ...
    TextView phonenumbertxtll, titletxt, desctxt , loginBack;
    ...
    PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Log.d(TAG, "onVerificationFailed: reason "+e.getMessage());
            Toast.makeText(getApplicationContext(), "SMS Code verification failed", Toast.LENGTH_SHORT).show();
        }
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                User userProfile = new User(user.getDisplayName(), user.getPhoneNumber(), user.getPhoneNumber());
                                FirebaseFirestore
                                        .getInstance()
                                        .collection("Users")
                                        .document(userId)
    ...
    public void signup() {
        ...
        if (!validate()) {
            ...
            startPhoneNumberVerification("+254"+input_phonenumber.getText().toString());
        }
